...
function paraInput(g: Gerador): Formulario { return { identificacao: g.identificacao, localizacao: g.localizacao, predio: g.predio, modelo: g.modelo, potencia_kva: String(g.potencia_kva), numero_serie: g.numero_serie ?? '', tanque_capacidade_litros: g.tanque_capacidade_litros ? String(g.tanque_capacidade_litros) : '' }; }
